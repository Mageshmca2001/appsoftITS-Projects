...
namespace AVG.ProductionProcess.PCBTest.Forms
{
    public partial class MainForm : Form
    {
        ...
        FinalTesting.Properties.Settings settings = new FinalTesting.Properties.Settings();
        #endregion
            ...
            try
            {
                if (btnCOMMOpen.Text == "COM Open")
                {
                    ...
                    if (isConnected == true)
                    {
                        ...
                        btnCOMMOpen.Image = FinalTesting.Properties.Resources.UnPlug;
                    }
                    else
                    {
                ...
                else if (btnCOMMOpen.Text == "COM Close")
                {
                    ...
                    btnCOMMOpen.Image = FinalTesting.Properties.Resources.plug;
