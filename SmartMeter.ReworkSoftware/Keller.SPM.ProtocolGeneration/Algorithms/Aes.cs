...
namespace DLMS_MeterReading
{
    public class DLMS_AES
    {
        ...
        public static byte[] Wrap(byte[] MasterKey, byte[] Global)
        {

            byte[] inputKek = MasterKey; //new byte[] { 0x41, 0x45, 0x49, 0x5F, 0x4D, 0x61, 0x73, 0x74, 0x65, 0x72, 0x6B, 0x65, 0x79, 0x41, 0x6C, 0x6C }; // AEI_MasterkeyAll
            ...
            //wrapp
            byte[] inputData = Global;//new byte[] { 78, 67, 67, 95, 71, 108, 111, 98, 97, 108, 107, 101, 121, 95, 69, 65 };//NCC_Globalkey_EA
